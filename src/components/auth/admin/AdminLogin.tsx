    ...
    <div className="flex min-h-screen overflow-x-hidden p-0">
      ...
      >
        <p className="mb-6 text-gray-600">
          Welcome back. Sign in to your admin account to securely access the dashboard and manage your platform.
        </p>
        ...
        >
          ...
          <motion.div
            ...
            className="flex w-[50%] items-center justify-between gap-4 rounded-[5px]  px-4 py-3"
          >
            <Link
              to="/vendor-forgot"
